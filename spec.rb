...
describe "Number to text" do
	it "should return a number in words" do
		number_to_text(0).must_equal "zero".downcase
		number_to_text(23).must_equal "Twenty three".downcase
		number_to_text(13).must_equal "thirteen".downcase
		...
		number_to_text(9233).must_equal "nine thousand and two hundred and thirty three".downcase
		...
		number_to_text(500000).must_equal "five hundred thousand".downcase
